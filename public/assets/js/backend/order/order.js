            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'goods.goods_name', title: __('商品名称')},
                        {field: 'goods.spec_image', title: __('商品主图'), events: Table.api.events.image, formatter: Table.api.formatter.image},
                        {field: 'goods.spec_key_name', title: __('商品规格')},
                        {field: 'user_remark', title: __('用户备注')},
                        {field: 'admin_remark', title: __('后台备注')},
                        // {field: 'mobile', title: __('Mobile')},
                        {field: 'wx', title: __('微信号')},
