...
class Alisms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIS8BVCcDlFqwY"; // AccessKeyId

        $accessKeySecret = "HZf7aavm9kBihfOZXoG6o6zZYFRMUU"; // AccessKeySecret
    ...
    public static function sendSms($phone, $code) {
        ...
        $request->setSignName("智光未来系统");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_140245012");
